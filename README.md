...
##Thought Process
I used different components to follow functional programming practice.
Also,Used form validation when used does not enter value and tries to add the temperature. 
Validation is provided when user tries to enter more than 8 values the form will be hidden and a message will be shown as you have exceeded your limit.
Median is calculated with own logic.
Used bootstrap for display purpose and also displayed progress bar.
